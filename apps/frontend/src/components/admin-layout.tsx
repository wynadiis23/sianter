import { LayoutGrid, Building2, Users, Settings, Clock, CalendarDays, FileText, ClipboardList, Printer } from 'lucide-react'
...
const navItems = [
  ...
  { title: 'Printer', url: '/admin/printer', icon: Printer },
]
